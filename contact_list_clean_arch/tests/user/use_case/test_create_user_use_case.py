...
from contact_list_clean_arch.tests.util.mock_path import user_command_gateway_path
...
class TestCreateUserUseCase(TestCase):
    ...
    def test_create_user_successfully(self):
        ...
        use_case = CreateUserUseCase(user_command_gateway)
        ...
        self.assertEqual("123", user_passed_to_be_saved.password)
