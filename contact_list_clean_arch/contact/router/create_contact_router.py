...
# from contact_list_clean_arch.config.bean import get_create_contact_use_case
...
from contact_list_clean_arch.contact.use_case.create_contact_use_case import InputModel, CreateContactUseCase
